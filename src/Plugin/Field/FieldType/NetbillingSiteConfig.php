...
class NetbillingSiteConfig extends FieldItemBase {
  ...
  public static function propertyDefinitions(FieldStorageDefinitionInterface $field_definition) {
    ...
    $properties['account_id'] = DataDefinition::create('string')
      ...
      ->setRequired(TRUE);
    $properties['site_id'] = DataDefinition::create('string')
      ->setLabel(new TranslatableMarkup('Site ID'))
      ->setSetting('case_sensitive', $field_definition->getSetting('case_sensitive'))
      ->addConstraint('Length', array('max' => $max_length))
      ->setRequired(TRUE);
  ...
  public static function generateSampleValue(FieldDefinitionInterface $field_definition) {
    $random = new Random();
    $values['site_id'] = $random->word(mt_rand(1, $field_definition->getSetting('max_length')));
  ...
  public function isEmpty() {
    ...
    $site_id = $this->get('site_id')->getValue();
