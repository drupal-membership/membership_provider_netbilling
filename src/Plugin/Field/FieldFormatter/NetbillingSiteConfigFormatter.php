...
/**
 * Plugin implementation of the 'netbilling_site_config' formatter.
 *
 * @FieldFormatter(
 *   id = "netbilling_site_config",
 *   label = @Translation("NETBilling site config formatter"),
 *   field_types = {
 *     "netbilling_site_config"
 *   }
 * )
 */
class NetbillingSiteConfigFormatter extends FormatterBase {
  /**
   * {@inheritdoc}
   */
